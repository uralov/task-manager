# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-04-02 05:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ManyToManyField(blank=True, related_name='task_assigned', to=settings.AUTH_USER_MODEL, verbose_name='Assigned to')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task_author', to=settings.AUTH_USER_MODEL, verbose_name='Author')),
            ],
        ),
        migrations.CreateModel(
            name='TaskActionLog',
